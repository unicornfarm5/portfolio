	...
	return (
		<section className="section-wrap py-24">
			...
			<div className="grid gap-6 md:grid-cols-2">
				<article className="relative border border-[#242323] px-7 pb-7 pt-12 md:px-10 md:pb-10 md:pt-14">
					<img src="/assets/paperclip.png" alt="" aria-hidden="true" className="absolute left-1/2 top-8 z-10 w-14 -translate-x-1/2 -translate-y-1/2" />
